...
export const Modal = () => {
  ...
  const {filePickerRef, captionRef} = useRef(null);
            ...
            >
              <div>
                ...
                <div className="mt-5 sm:mt-6">
                  ...
                  border-transparent shadow-sm px-4 focus:ring-offset-2
                  focus:ring-red-500 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed
                  hover:disabled:bg-gray-300 py-2 bg-red-600 text-base font-medium text-white
